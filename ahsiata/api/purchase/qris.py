...
from ahsiata.ui.style import fail, info
import base64
...
def get_qris_code(api_key: str, tokens: dict, transaction_id: str) -> str | None:
    ...
    if not isinstance(res, dict) or res.get("status") != "SUCCESS":
        print(fail(f"Gagal mengambil kode QRIS: {res}"))
        return None
...
def show_qris_payment(
    ...
    print(info(f"Atau buka link berikut untuk melihat QRIS:\n{QRIS_VIEWER_URL.format(qris_b64=qris_b64)}"))
    return qris_b64
